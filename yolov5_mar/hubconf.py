...
def create_model(pretrained_model, autoshape=True):
    ...
    Returns:
        pytorch model
    """
    model = torch.load(pretrained_model) if isinstance(pretrained_model, str) else pretrained_model  # load checkpoint
